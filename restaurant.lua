...
local Window = Rayfield:CreateWindow({
	Name = "Snake Hub 🐍👑",
	LoadingTitle = "Loading Up Snake Hub",
	LoadingSubtitle = "by bisu!#6810",
	ConfigurationSaving = {
		Enabled = false,
        ...
        Discord = {
        	Enabled = true,
        	Invite = "TQxPx3u9Xw", -- The Discord invite code, do not include discord.gg/
...
local Section = Tab:CreateSection("My Restaurant!")    
...
_b.Size=UDim2.new(0,370,0,21)_b.Font=Enum.Font.Arial;_b.Text="Made by Statue"
